"""
noise_psd_g3_150ghz.py
Compute BB noise pseudo-Cl from sign-flip 150GHz G3 maps.
Run from terminal: python noise_psd_g3_150ghz.py
"""

# cd ~/Initial_test/Code/Map_Operation

# nohup python -u noise_psd_g3_150ghz.py > noise_psd_g3_150ghz.log 2>&1 &

# tail -f noise_psd_g3_150ghz.log
...
LMAX     = 3000
OUT_FILE = os.path.expanduser("~/Initial_test/Code/Map_Operation/outputs/noise_psd_BB_g3_150ghz.npz")
